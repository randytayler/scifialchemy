//var non=[[.8,313.5,0,208.5,0,352.24,200,234.26,200,419.53,400,313.5,400],[.8,352.24,0,234.26,0,395.78,200,263.22,200,471.38,400,352.24,400],[.8,395.78,0,263.22,0,444.7,200,295.75,200,529.64,400,395.78,400],[.8,444.7,0,295.75,0,499.67,200,332.3,200,595.1,400,444.7,400]];
var non=[[[.4,263.22,0],[1.5,395.78,200,263.22,200]],[[.4,395.78,0],[1.5,529.64,200,395.78,200]],[[.4,196.69,0],[1.5,263.22,200,196.69,200]]];
var sw=[[2,130.81,0,130.81,200,130.81,400,175.05,600,263.2,1600]];
var ce=[[2,352.24,0,395.78,400,313.5,800,155.8,1200,234.26,1600]];
var st=[[2,175.05,0,234.26,800,313.5,1100,295.75,2500,234.26,3000,196.7,3400,263.2,3900,352.2,4300]];
var bttf=[[2.5,352.24,0,234.26,800,332.30,1600,352.24,2800,395.78,3000,352.24,3200,295.75,3650,234.26,4200,332.30,4600]];
var ali=[[2,185.56,0,155.8,300,185.56,600,471.4,1100,313.5,1100,373.4,1600,234.26,1600,471.4,2100,313.5,2100,373.4,2600,234.26,2600,471.4,3100,313.5,3100,373.4,3600,234.26,3600]];
var tt1=[[]];
var rag=[
	//[.8,185.56,0,185.56,250,185.56,400,373.38,550,185.56,700],
	[2,138.66,500,279.01,700,263.22,900,279.01,1900]
];
var elements=[];
elements[0]=['force','🧲',[]];
elements[1]=['goodness','😇',[]];
...
elements[19]=['evolution',['⬈','🦠'],[[40,50,60],[0,80,50]],'Eons of survival of the fittest, culminating in you, playing video games while you use the bathroom.'];
...
elements[46]=['machine',['⚙️','⚙️'],[[-30,70],[42,70]],'Labor-saving devices are the most satisfying product of hard work.'];
...
elements[65]=['post-apocalypse','',[]];//nix
...
elements[75]=['Emperor','r9999666000;r19588042020000;yFCC000336659977161;e54452434000FCC;pnon00006M30,99c19-23,3-43,4-52;pnon00006M35,48c-5-25,5-38,28-35;c664103nonCF3;c504103nonCF3;p02000001M99,85C69,58,69,21,60,16C43,4,23,20,36,62c8,13-5,37-9,37H0V65C26,1,50-5,69,6c15,10,15,39,31,50v29H99z;pnon99901M41,44c0,2,6,12,15,2;pnon99901M62,45c0,2,11,7,11,0','svg','"Please don\'t use my face as a wash board" - Darth Sidious'];
elements[76]=['Total Recall',['🌋','👩‍🚀','👨🏻‍🚀'],[[-10,80,90],[-20,110,60],[50,110,60]],'Because Quatto. Remember? The mutant leader of the rebels?',1];
...
elements[98]=['Close Encounters of the Third Kind',['⛰️','🛸'],[[0,100],[0,30]],'This means something.',1];
elements[99]=['flying car',['| | | |','🚗'],[[28,80,20],[0,40]],'STILL no flying cars? Thanks, Biden.'];

elements[100]=['BladeRunner','',[],'Harrison Ford\'s only science fiction role, IIRC',1];
elements[101]=['The Fifth Element',['| | | |','🚕'],[[28,80,20],[0,40]],'It\'s also what makes a Subaru, a Subaru.',1];
